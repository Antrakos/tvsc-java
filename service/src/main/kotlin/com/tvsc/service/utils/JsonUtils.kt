 ...
 */
@Component
open class JsonUtils @Autowired constructor(val objectMapper: ObjectMapper) {

    fun getNext(json: String): Int? {
        val asText = ExceptionUtil.wrapCheckedException(JsonException("Cannot read tree")) { objectMapper.readTree(json) }.at("/links/next").asText()
